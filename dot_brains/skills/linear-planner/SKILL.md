...
When reviewing feature, make sure you browse the codebase to make sure what changes are needed. On full-stack repos, make sure to review both stacks.

Issues should be small and contained. If they are multiple concerns feel free to break them up. Feel free to ask guidance on how to break things.

If creating issues for a full-stack feature, please break issues apart. Create a proto-parent issue with just basic context and then detail the subissues for the FE and the BE. Do not include implementation issues on the parent.
